...
import com.example.adminbooking.Adapter.DriverAdapter;
...
public class Driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("DRIVERS").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                DriverAdapter adapter = new DriverAdapter(context, users);
        ...
        addUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(click == true){
                    textPassword.setHint("Mobile Number");
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    String name, mobileNumber, userId;

                    name = textName.getText().toString().trim();
                    mobileNumber = textPassword.getText().toString().trim();
                    userId = idText.getText().toString();

                    UserDetails user = new UserDetails(userId, name,mobileNumber);
                    myRef.child("DRIVERS").child(userId).setValue(user);
                    myRef.child("DRIVER_ID").setValue(userId);
    ...
    private void createUserId() {
        ...
        myRef.child("DRIVER_ID").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    idText.setText("1");
                    myRef.child("DRIVER_ID").setValue("1");
                }
